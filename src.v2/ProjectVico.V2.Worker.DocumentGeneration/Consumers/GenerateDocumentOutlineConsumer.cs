...
public class GenerateDocumentOutlineConsumer : IConsumer<GenerateDocumentOutline>
{
    ...
    public async Task Consume(ConsumeContext<GenerateDocumentOutline> context)
    {
        ...
        var existingDocument = await _dbContext.GeneratedDocuments.FindAsync(generateDocumentOutlineCommand.CorrelationId);
        ...
        await context.Publish(new DocumentOutlineGenerated(generateDocumentOutlineCommand.CorrelationId)
        {
            GeneratedDocumentJson = jsonOutputGeneratedDocument,
            AuthorOid = generateDocumentOutlineCommand.AuthorOid
        });
