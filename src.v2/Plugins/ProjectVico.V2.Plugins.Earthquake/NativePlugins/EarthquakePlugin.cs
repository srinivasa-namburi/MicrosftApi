...
namespace ProjectVico.V2.Plugins.Earthquake.NativePlugins;

public class EarthquakePlugin
{
    ...
    )
    {
        ...
        var responseData = await this.GetDetailedEarthquakesForLatLongAsync(latitude, longitude, maxRadiusKm, maxResults, minMagnitude, minDate, maxDate, sortOrder);
        return responseData;
    }
