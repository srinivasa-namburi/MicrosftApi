...
using ProjectVico.V2.Plugins.GeographicalData.Models;

namespace ProjectVico.V2.Plugins.GeographicalData.NativePlugins;

public class FacilitiesPlugin
{
    ...
    public async Task<List<FacilityDetail>> GetFacilitiesByAddressAsync(
        ...
        string categorySearchTerm)
    {
        var latLongResponse = await this.GetLatLongForAddressAsync(address);
