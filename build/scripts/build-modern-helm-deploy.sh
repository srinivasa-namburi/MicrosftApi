...
# ⚠️  DEPRECATED: This script is deprecated in favor of build-modern-helm-deploy-clean.sh
#
# Both ADO and GitHub Actions pipelines now use build-modern-helm-deploy-clean.sh
# which provides:
# - Unified deployment logic across platforms
# - Better secret handling (Azure Maps, OpenAI)
# - Post-Helm secret patching for reliability
#
# Please update your scripts to use build-modern-helm-deploy-clean.sh instead.
#
# This script is kept for backward compatibility but may be removed in a future version.
# ============================================================================================
...
echo "⚠️  WARNING: This script is deprecated. Please use build-modern-helm-deploy-clean.sh instead."
echo "   Both ADO and GitHub Actions now use the unified clean script."
