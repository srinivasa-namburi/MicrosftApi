# Solution Deployment (Legacy)

> **⚠️ LEGACY DOCUMENTATION**  
> This document contains legacy deployment instructions for Container Apps-based deployments.
> For modern Kubernetes/Aspire 9.4 deployments, see:
> - [DEPLOYMENT.ADO.md](../../DEPLOYMENT.ADO.md) - Azure DevOps deployment
> - [DEPLOYMENT.GitHub.md](../../DEPLOYMENT.GitHub.md) - GitHub Actions deployment
...
- ![ForkGithubRepository](../assets/ForkRepository.png)
...
3. Create the following pre-req resources in Azure Portal. These can be in any Resource Group:
   ...
   - ![ConfigureAzureResources](../assets/ConfigureAzureResources.png)
...
![SetGithubSecrets](../assets/GithubSecrets.png)
