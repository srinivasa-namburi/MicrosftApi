...
public class USNRCEnvironmentalReportBodyTextGenerator : IBodyTextGenerator
{
    ...
    private readonly ILogger<USNRCEnvironmentalReportBodyTextGenerator> _logger;

    public USNRCEnvironmentalReportBodyTextGenerator
    (
        ...
        ILogger<USNRCEnvironmentalReportBodyTextGenerator> logger 
    )
    {
        ...
        string sectionOrTitleText)
    {
        ...
        var searchResult = await _kernelMemoryRepository.SearchAsync(ProcessName, sectionOrTitleNumber + " " + sectionOrTitleText, top: 50);
