...
/// <summary>
/// Represents a single requirement field that needs to be collected in a Flow Task.
/// </summary>
public class FlowTaskRequirement : EntityBase
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the parent section.
    /// </summary>
    public virtual FlowTaskSection FlowTaskSection { get; set; } = null!;

    /// <summary>
    /// Gets or sets the data source if this requirement is data-sourced.
    /// </summary>
    public virtual FlowTaskDataSource? DataSource { get; set; }
}