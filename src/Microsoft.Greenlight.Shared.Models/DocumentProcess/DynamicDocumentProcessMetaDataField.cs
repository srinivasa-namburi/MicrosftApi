...
{
    /// <summary>
    /// Represents a metadata field in a dynamic document process.
    /// </summary>
    public class DynamicDocumentProcessMetaDataField : EntityBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Dynamic Document Process Definition this field belongs to.
        /// </summary>
        ...
        /// </summary>
        public required DynamicDocumentProcessMetaDataFieldType FieldType { get; set; }
