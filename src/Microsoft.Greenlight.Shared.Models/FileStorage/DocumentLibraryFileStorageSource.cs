...
/// <summary>
/// Represents the association between a document library and a file storage source.
/// </summary>
public class DocumentLibraryFileStorageSource : EntityBase
{
    /// <summary>
    ...
    /// <summary>
    /// Navigation property for the associated document library.
    /// </summary>
    public virtual DocumentLibrary.DocumentLibrary DocumentLibrary { get; set; } = null!;
