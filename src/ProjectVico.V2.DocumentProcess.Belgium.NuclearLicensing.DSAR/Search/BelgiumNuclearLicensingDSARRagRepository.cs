...
namespace ProjectVico.V2.DocumentProcess.Belgium.NuclearLicensing.DSAR.Search;
...
public class BelgiumNuclearLicensingDSARRagRepository : BaseRagRepository, IRagRepository
{
        ...
        : base(indexingProcessor, logger)
    {
        ...
        _documentProcessOptions = _serviceConfigurationOptions.ProjectVicoServices.DocumentProcesses.Single(x => x.Name == "Belgium.NuclearLicensing.DSAR");
