...
public class GetFacilitiesForLocationRequest
{
    ...
    /// </summary>
    [OpenApiProperty(Description = "Latitude of the location to search for facilities represented as a string")]
    ...
    /// </summary>
    [OpenApiProperty(Description = "Longitude of the location to search for facilities represented as a string")]
