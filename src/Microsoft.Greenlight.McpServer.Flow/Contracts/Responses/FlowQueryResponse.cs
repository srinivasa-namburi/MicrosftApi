...
public record FlowQueryResponse
{
    ...
    /// <summary>
    /// The Flow conversation ID for this conversation.
    /// Clients should include this in subsequent requests to continue this conversation.
    /// </summary>
    [JsonPropertyName("flowConversationId")]
    public string FlowConversationId { get; init; } = string.Empty;
